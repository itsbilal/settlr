...
console.log(url);
promisify.f(request, "http://sampleserver6.arcgisonline.com/arcgis/rest/services/Utilities/Geometry/GeometryServer/areasAndLengths?f=json&polygons=" + JSON.stringify(polygons) + "&sr=4326&lengthUnit=9001&areaUnit=" + JSON.stringify({"areaUnit":"esriSquareMeters"}) + "&calculationType=geodesic")
